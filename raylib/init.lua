...
rl = raygui(rl)
  ...
  rl.DEG2RAD = (rl.PI / 180)

  
  rl.RAD2DEG = (180 / rl.PI)
  ...
  rl.SUPPORT_MODULE_RSHAPES = 1

  
  rl.SUPPORT_MODULE_RTEXTURES = 1

  --- WARNING: It requires SUPPORT_MODULE_RTEXTURES to load sprite font textures
  rl.SUPPORT_MODULE_RTEXT = 1

  
  rl.SUPPORT_MODULE_RMODELS = 1

  
  rl.SUPPORT_MODULE_RAUDIO = 1

  
  rl.SUPPORT_CAMERA_SYSTEM = 1

  
  rl.SUPPORT_GESTURES_SYSTEM = 1

  
  rl.SUPPORT_RPRAND_GENERATOR = 1

  
  rl.SUPPORT_MOUSE_GESTURES = 1

  
  rl.SUPPORT_SSH_KEYBOARD_RPI = 1

  
  rl.SUPPORT_WINMM_HIGHRES_TIMER = 1

  
  rl.SUPPORT_PARTIALBUSY_WAIT_LOOP = 1

  
  rl.SUPPORT_SCREEN_CAPTURE = 1

  
  rl.SUPPORT_GIF_RECORDING = 1

  
  rl.SUPPORT_COMPRESSION_API = 1

  
  rl.SUPPORT_AUTOMATION_EVENTS = 1

  --- Maximum file paths capacity
  rl.MAX_FILEPATH_CAPACITY = 8192

  --- Maximum length for filepaths (Linux PATH_MAX default value)
  rl.MAX_FILEPATH_LENGTH = 4096

  --- Maximum number of keyboard keys supported
  rl.MAX_KEYBOARD_KEYS = 512

  --- Maximum number of mouse buttons supported
  rl.MAX_MOUSE_BUTTONS = 8

  --- Maximum number of gamepads supported
  rl.MAX_GAMEPADS = 4

  --- Maximum number of axis supported (per gamepad)
  rl.MAX_GAMEPAD_AXIS = 8

  --- Maximum number of buttons supported (per gamepad)
  rl.MAX_GAMEPAD_BUTTONS = 32

  --- Maximum vibration time in seconds
  rl.MAX_GAMEPAD_VIBRATION_TIME = 2.0

  --- Maximum number of touch points supported
  rl.MAX_TOUCH_POINTS = 8

  --- Maximum number of keys in the key input queue
  rl.MAX_KEY_PRESSED_QUEUE = 16

  --- Maximum number of characters in the char input queue
  rl.MAX_CHAR_PRESSED_QUEUE = 16

  --- Max size allocated for decompression in MB
  rl.MAX_DECOMPRESSION_SIZE = 64

  --- Maximum number of automation events to record
  rl.MAX_AUTOMATION_EVENTS = 16384

  --- GPU skinning, comment if your GPU does not support more than 8 VBOs
  rl.RL_SUPPORT_MESH_GPU_SKINNING = 1

  
  rl.SUPPORT_QUADS_DRAW_MODE = 1

  --- Spline segments subdivisions
  rl.SPLINE_SEGMENT_DIVISIONS = 24

  
  rl.SUPPORT_FILEFORMAT_PNG = 1

  
  rl.SUPPORT_FILEFORMAT_GIF = 1

  
  rl.SUPPORT_FILEFORMAT_QOI = 1

  
  rl.SUPPORT_FILEFORMAT_DDS = 1

  
  rl.SUPPORT_IMAGE_EXPORT = 1

  
  rl.SUPPORT_IMAGE_GENERATION = 1

  
  rl.SUPPORT_IMAGE_MANIPULATION = 1

  
  rl.SUPPORT_DEFAULT_FONT = 1

  
  rl.SUPPORT_FILEFORMAT_TTF = 1

  
  rl.SUPPORT_FILEFORMAT_FNT = 1

  
  rl.SUPPORT_TEXT_MANIPULATION = 1

  
  rl.SUPPORT_FONT_ATLAS_WHITE_REC = 1

  --- Size of internal static buffers used on some functions:
  rl.MAX_TEXT_BUFFER_LENGTH = 1024

  --- Maximum number of substrings to split: TextSplit()
  rl.MAX_TEXTSPLIT_COUNT = 128

  
  rl.SUPPORT_FILEFORMAT_OBJ = 1

  
  rl.SUPPORT_FILEFORMAT_MTL = 1

  
  rl.SUPPORT_FILEFORMAT_IQM = 1

  
  rl.SUPPORT_FILEFORMAT_GLTF = 1

  
  rl.SUPPORT_FILEFORMAT_VOX = 1

  
  rl.SUPPORT_FILEFORMAT_M3D = 1

  
  rl.SUPPORT_MESH_GENERATION = 1

  --- Maximum number of shader maps supported
  rl.MAX_MATERIAL_MAPS = 12

  --- Maximum vertex buffers (VBO) per mesh
  rl.MAX_MESH_VERTEX_BUFFERS = 9

  
  rl.SUPPORT_FILEFORMAT_WAV = 1

  
  rl.SUPPORT_FILEFORMAT_OGG = 1

  
  rl.SUPPORT_FILEFORMAT_MP3 = 1

  
  rl.SUPPORT_FILEFORMAT_QOA = 1

  
  rl.SUPPORT_FILEFORMAT_XM = 1

  
  rl.SUPPORT_FILEFORMAT_MOD = 1

  --- Device output channels: stereo
  rl.AUDIO_DEVICE_CHANNELS = 2

  --- Device sample rate (device default)
  rl.AUDIO_DEVICE_SAMPLE_RATE = 0

  --- Maximum number of audio pool channels
  rl.MAX_AUDIO_BUFFER_POOL_CHANNELS = 16

  
  rl.SUPPORT_STANDARD_FILEIO = 1

  
  rl.SUPPORT_TRACELOG = 1

  --- Max length of one trace-log message
  rl.MAX_TRACELOG_MSG_LENGTH = 256

  
  rl.SUPPORT_CLIPBOARD_IMAGE = 1

  
  rl.SUPPORT_FILEFORMAT_BMP = 1

  
  rl.SUPPORT_FILEFORMAT_JPG = 1
  ...
  ---@class float3
  ---@field v number[] {number, number, number} 
  
  --- NOTE: Helper types to be used instead of array return types for *ToFloat functions 
  ---@param v number[] {number, number, number}
  ---@return float3
  function rl.float3(v)
    return ffi.new("float3", v)
  end
  ...
  ---@param v number[] {number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number}
  ---@return float16
  function rl.float16(v)
    return ffi.new("float16", v)
  end
