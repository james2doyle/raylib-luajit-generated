...
while not rl.WindowShouldClose() do
    ...
    if cameraPitch > 89.0 then cameraPitch = 89.0 end
    if cameraPitch < -45.0 then cameraPitch = -45.0 end
    ...
    rl.BeginDrawing()
        ...
        rl.DrawText(string.format("Player Position: (%.2f, %.2f, %.2f)", playerPosition.x, playerPosition.y, playerPosition.z), 10, 80, 10, rl.DARKGRAY)
