...
local background = rl.LoadTexture("examples/resources/cyberpunk_street_background.png")
local midground = rl.LoadTexture("examples/resources/cyberpunk_street_midground.png")
local foreground = rl.LoadTexture("examples/resources/cyberpunk_street_foreground.png")
